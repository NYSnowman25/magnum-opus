...
namespace StatusBarKind {
    ...
    export const big_Thug_1 = StatusBarKind.create()
}
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.MegaCrav, function (sprite, otherSprite) {
    if (crab == 2) {
        clawSmash()
    }
})
function level1 () {
    ...
    escapeTruck = sprites.create(img`
        ...
        ........................fffffff11227d72222dffff...
        .......................ffffffff112227221111f1ff...
        .......................ffffffff11222222111111ff...
        ......................fffffffff11d22222111111ff...
...
statusbars.onStatusReached(StatusBarKind.crabBar, statusbars.StatusComparison.LTE, statusbars.ComparisonType.Percentage, 50, function (status) {
    megaCrav.setImage(img`
        ...
        .......fff......f2ff282ff282ff2f......fff.......
        ........ffff....f2ff222ff222ff2f....ffff........
...
statusbars.onZero(StatusBarKind.crabBar, function (status) {
    ...
    megaCrav.destroy(effects.fire, 2000)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.smash, function (sprite, otherSprite) {
    statusbar.value += -100
})
...
function slam () {
    if (crab == 1) {
        megaCrav.setImage(img`
            ...
            .......66622...666............666...22666.......
            .......66622...266............662...22666.......
            ......666222...266............662...222666......
            ......666222.22266............66222.222666......
            ......666222.22666............66622.222666......
            ......66622222666..............66622222666......
            .......666222666................666222666.......
            .......66622666..................66622666.......
            ........666666........2222........666666........
            .........6666.....222222222222.....6666.........
            ..........66......888822228888......66..........
            ..........66....66ff22222222ff66....66..........
            ..........66....62ff22222222ff26....66..........
            ..........6666662222222222222222666666..........
            ..........6666662222222222222222666666..........
            ...........66.66222222222222222266.66...........
            ..............66622222222222222666..............
            ............ff..6222222222222226..ff............
            ............ff..6662222222222666..ff............
            ............ff..ff622222222226ff..ff............
        ...
        megaCrav.setImage(img`
            ...
            ...66622222666....................66622222666...
            ...6666222666......................6662226666...
            ...966666666..........2222..........666666669...
            ...95666666.......222222222222.......66666659...
            ...9556666........888822228888........6666559...
            ...9454666......66ff22222222ff66......6664549...
            ...944496666....62ff22222222ff26....666694449...
            ..92242296666666222222222222222266666669224229..
            ..9224229...666622222222222222226666...9224229..
            ....222.......66222222222222222266.......222....
            ....222.......66622222222222222666.......222....
            .....2......ff..6222222222222226..ff......2.....
            .....2......ff..6662222222222666..ff......2.....
            ..........ff....ff622222222226ff....ff..........
            ..........ff....ff662222222266ff....ff..........
            ..........ff..ff...6666666666...ff..ff..........
            ..........ff..ff................ff..ff..........
        ...
        megaCrav.setVelocity(mySprite.x - megaCrav.x, -150)
        megaCrav.ay = 200
        pause(1000)
        megaCrav.setKind(SpriteKind.MegaCrav)
        megaCrav.setImage(img`
    ...
    if (crab == 2) {
        megaCrav.setImage(img`
            ...
            .......ffff2...fff............fff...2ffff.......
            .......ffff2...fff............fff...2ffff.......
            ......ffff22...fff............fff...22ffff......
            ......fff222.22fff............fff22.222fff......
            ......ffff22.2ffff............ffff2.22ffff......
            ......fffff22ffff..............ffff22fffff......
            .......ffff2ffff................ffff2ffff.......
            .......ffffffff..................ffffffff.......
            ........ffffff........ffff........ffffff........
            .........ffff.....882ffffff288.....ffff.........
            ..........ff......2282ffff2822......ff..........
            ..........ff....f2ff282ff282ff2f....ff..........
            ..........ff....f2ff222ff222ff2f....ff..........
            ..........fffffff2222ffffff2222fffffff..........
            ..........ffffffffffffffffffffffffffff..........
            ...........ff.ffffffffffffffffffff.ff...........
            ..............ffffffffffffffffffff..............
            ............4e..ffffffffffffffff..e4............
            ............4e..ffffffffffffffff..e4............
            ............4e..4effffffffffffe4..e4............
            ............4e..4effffffffffffe4..e4............
            .............4e.4e.ffffffffff.e4.e4.............
            .............4e.4e............e4.e4.............
            ..............4e.4e..........e4.e4..............
            ..............4e.4e..........e4.e4..............
            ................................................
        ...
        megaCrav.setImage(img`
            ...
            ...fffff2fffff....................fffff2fffff...
            ...ffffffffff......................ffffffffff...
            ...9ffffffff..........ffff..........ffffffff9...
            ...95ffffff.......882ffffff288.......ffffff59...
            ...955ffff........2282ffff2822........ffff559...
            ...9454fff......f2ff282ff282ff2f......fff4549...
            ...94449ffff....f2ff222ff222ff2f....ffff94449...
            ..9224229ffffffff2222ffffff2222ffffffff9224229..
            ..9224229...ffffffffffffffffffffffff...9224229..
            ....222.......ffffffffffffffffffff.......222....
            ....222.......ffffffffffffffffffff.......222....
            .....2......44..ffffffffffffffff..44......2.....
            .....2......4e..ffffffffffffffff..e4......2.....
            ..........44....44ffffffffffff44....44..........
            ..........4e....4effffffffffffe4....e4..........
            ..........4e..44...ffffffffff...44..e4..........
            ..........4e..4e................e4..e4..........
...
function fire_ball () {
    fireBall = sprites.createProjectileFromSprite(img`
        ...
        . . . . . . 5 5 5 5 . . . . . . 
        . . . . . . . 5 5 . . . . . . . 
        `, megaCrav, mySprite.x - megaCrav.x, -150)
    fireBall.ay = 200
...
function clawSmash () {
    megaCrav.setImage(img`
        ...
        ........ffffff....................ffffff........
        .......fff3333f..................f3333fff.......
        ......ffff3333ff................ff3333ffff......
        ......ffff..33ff................ff33..ffff......
        ......fff2..33ff................ff33..2fff......
        .....ffff2....fff..............fff....2ffff.....
        .....ffff2....fff..............fff....2ffff.....
        ....fffff222..fff..............fff..222fffff....
        ....fff22222fffff..............fffff22222fff....
        ....ffff2222ffff................ffff2222ffff....
        ....fffff222ffff................ffff222fffff....
        .....fffff2fffff................fffff2fffff.....
        .....ffffffffff..................ffffffffff.....
        ......ffffffff....................ffffffff......
        .......ffffff......................ffffff.......
        ...
        ..........ff......882ffffff288......ff..........
        ..........ff......2282ffff2822......ff..........
        ...........f....f2ff282ff282ff2f....f...........
        ...........f....f2ff222ff222ff2f....f...........
        ...........ffffff2222ffffff2222ffffff...........
        ............ffffffffffffffffffffffff............
        ..............ffffffffffffffffffff..............
        ..............ffffffffffffffffffff..............
        ............44..ffffffffffffffff..44............
    ...
    megaCrav.setImage(img`
        ...
        ................................882ffffff288................................
        ................................2282ffff2822................................
        ...1..1..........fffffff......f2ff282ff282ff2f......fffffff..........1..1...
        ..1..1........ffffffffffff....f2ff222ff222ff2f....ffffffffffff........1..1..
        .1..1.......fffffffffffffffffff2222ffffff2222fffffffffffffffffff.......1..1.
        1..1........fffffffffffff..ffffffffffffffffffffff..fffffffffffff........1..1
        1..1......fffffffffffff.....ffffffffffffffffffff.....fffffffffffff......1..1
        1..1....33fffff2222fff......ffffffffffffffffffff......fff2222fffff33....1..1
        1..1....33ff....22ffff....44..ffffffffffffffff..44....ffff22....ff33....1..1
        1..1............22fff.....4e..ffffffffffffffff..e4.....fff22............1..1
        1..1..........222ffff...44....44ffffffffffff44....44...ffff222..........1..1
        1..1..3333....222fff....4e....4effffffffffffe4....e4....fff222....3333..1..1
        1..1..3333.22222fff.....4e..44...ffffffffff...44..e4.....fff22222.3333..1..1
        1..1..ffffffffffff......4e..4e................e4..e4......ffffffffffff..1..1
        .1..1..fffffffffff......4e..4e................e4..e4......fffffffffff..1..1.
        ..1..1..fffffffff.......4e..4e................e4..e4.......fffffffff..1..1..
        ............................................................................
        ............................................................................
        `)
    megaCrav.setKind(SpriteKind.smash)
    pause(500)
    megaCrav.setImage(img`
        ................................................
        ................................................
